...
modify the contents of the `src/linq/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/linq-team/linq-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/linq-team/linq-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
